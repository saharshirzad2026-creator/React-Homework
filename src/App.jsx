...
const App = ()=>{
  ...
  return(
    <>
      <Navbar/>
      <h1 className="text-3xl font-bold text-center text-red-700 border-2 border-b-rose-900 rounded-md my-3">Hello and good afternoon everyone This is the home page</h1>
